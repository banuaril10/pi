...
// ==== CEK USER KHUSUS: planogrambypass ====
if ($username == 'planogrambypass') {
    // Hanya tampilkan 1 menu
?>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item">
                        <a href="capture_sku_plano_darmadi.php" class='sidebar-link'>
                            <i class="bi bi-camera"></i>
                            <span>Planogram Darmadi</span>
                        </a>
                    </li>
...
<?php
    ...
    // ==== MENU NORMAL (SEMUA USER SELAIN planogrambypass) ====
?>
    <div id="sidebar" class="active">
        <div class="sidebar-wrapper active">
            <div class="sidebar-header">
