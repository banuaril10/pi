			document.getElementById("btn-cetak-tinta").addEventListener("click", function() { //cetak besar
				...
				var barcode = res[9];
						...
						text += "<td style='border: 0.5px solid #000'><div style='margin:5px 5px 0 5px; color: black; width: 177px; height: 121px; font-family: Calibri; '><div style='height:25px; text-align: left; font-size: 10px'><b>"+name.toUpperCase()+"</b></div><label style='text-align: left; font-size: 10px'><b>Rp </b></label><label style='text-align: left; font-size: 18px; text-decoration: line-through;'><b>"+formatRupiah(normal, '')+"</b></label><label style='float: right !important; font-size: 10px;'> s.d. "+todate+"</label><label style='margin: -10px 0 0 0; float: right; font-size: "+sizeprice+"'><label style='font-size: 10px'><b>Rp </b></label><b>"+formatRupiah(afterdiscount, '')+"</b></label> &nbsp &nbsp &nbsp &nbsp &nbsp <br><br><br><hr style='width: 100%;border-top: solid 1px #000 !important; background-color:black; border:none; height:1px; margin:1.5px 0 0 0;'><label style='text-align: center; font-size: 8px; margin-top: -10px'>"+newStr+"</label></div></td>";
