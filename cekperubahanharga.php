				 ...
				 <br>
					<table class="table table-bordered" id="example">
						...
						?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row1['price']; ?>|<?php echo $row['tgl_sekarang']; ?>|<?php echo $row['rack_name']; ?>|<?php echo $row['barcode']; ?>|<?php echo $harga_last; ?>|<?php echo $row['tag']; ?>|<?php echo $storecode.'/'.date('dmy'); ?>|<?php echo $row['barcode']; ?>"></td>
