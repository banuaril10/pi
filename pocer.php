			...
			<div class="tables">			
				...
				<input type="text" id="search" class="form-control" id="exampleInputName2" placeholder="Search">
					<table class="table table-bordered" id="example">
						...
						<?php 
						$sql_list = "SELECT 
							SUM(CASE WHEN (billamount - paycashgiven) = 30000 THEN 1 ELSE 0 END) AS total_30rb,
							SUM(CASE WHEN (billamount - paycashgiven) = 5000 THEN 1 ELSE 0 END) AS total_5rb
						FROM pos_dsales 
						...
						?>
							...
							<tr>
								...
								<td><?php echo $row['total_30rb']; ?></td>
								<td><?php echo $row['total_5rb']; ?> </td>
							</tr>
