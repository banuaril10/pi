...
<div class="row">
	<div class="col-12">
		...
		<?php $list_line = "select m_piline.issync, m_piline.sku ,m_piline.qtyerp, m_piline.qtysales, m_piline.qtycount, pos_mproduct.name, m_pi.status, m_piline.verifiedcount from m_pi inner join m_piline on m_pi.m_pi_key = m_piline.m_pi_key left join pos_mproduct on m_piline.sku = pos_mproduct.sku 
