			...
			<form action="" method="GET">
			 ...
			 <table>
				...
				<option value="">Pilih Rack</option>
					<?php 
						$rack = "select rack from pos_mproduct where rack != '' group by rack order by rack asc";
						$no = 1;
				 ...
				 <br>
					<table class="table table-bordered table-hover" id="example">
						...
						?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row['price']; ?>|<?php echo $row['tgl_sekarang']; ?>|<?php echo $row['rack_name']; ?>|<?php echo $row['shortcut']; ?>|<?php echo $harga_last; ?>|<?php echo $row['tag']; ?>|<?php echo $storecode.'/'.date('dmy'); ?>|<?php echo $row['barcode']; ?>"></td>
