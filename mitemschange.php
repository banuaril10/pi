				 ...
				 <br>
					<table class="table table-bordered table-hover" id="example">
						...
						?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['ni']; ?>|<?php echo $row['price_new']; ?>|<?php echo $row['tgl_sekarang']; ?>|<?php echo $row['rack_name']; ?>|<?php echo $row['barcode']; ?>|<?php echo $harga_last; ?>|<?php echo $row['tag']; ?>|<?php echo date('dmy'); ?>"></td>
