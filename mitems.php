...
<input type="text" id="price" value="45px"  placeholder="Ukuran Font Harga">
				...
				<tr>
					...
					<td><center><button class="btn btn-primary" id="btn-cetak"><div class="item1"><b>CETAK BESAR DOT </b></div></button></center></td>
					<td><center><button class="btn btn-danger" type="button" id="btn-cetak1"><div class="item1"><b>CETAK KECIL DOT </b></div></button></center></td>
					<td><center><button class="btn btn-success" type="button" id="btn-cetak-tinta"><div class="item1"><b>CETAK BESAR TINTA</b></div></button></center></td>
					<td><center><button class="btn btn-warning" type="button" id="btn-cetak1-tinta"><div class="item1"><b>CETAK KECIL TINTA</b></div></button></center></td>
			 ...
			 <table>
				...
				<input type="text" id="search" class="form-control" id="exampleInputName2" placeholder="Search">
					...
					<table class="table table-bordered" id="example">
						...
						$sql_list = "select date(now()) as tgl_sekarang, a.sku, a.name ,b.rack_name, a.price from pos_mproduct a inner join inv_mproduct b on a.sku = b.sku 
						";
						...
						?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row['price']; ?>|<?php echo $row['tgl_sekarang']; ?>|<?php echo $row['rack_name']; ?>|<?php echo $row['shortcut']; ?>"></td>
...
function formatRupiah(angka, prefix){
			...
			document.getElementById("btn-cetak1").addEventListener("click", function() { //cetak besar
				...
				let text = "<div style='position: relative; width: 920px; height: 151px; padding-top: 15px; '>";
				var x = 1;
				for (let i = 0; i < array.length; i++) {
						var res = array[i].split("|");
